...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("Pet & Classifier Label Match: {:5.1f}%".format(results_stats_dic['pct_match']))
    
    # Print dog classification percentages
    print("Dogs Correctly Classified: {:5.1f}%".format(results_stats_dic['pct_correct_dogs']))
    print("Not-Dogs Correctly Classified: {:5.1f}%".format(results_stats_dic['pct_correct_notdogs']))
    
    # Print breed classification percentage
    print("Dogs Breed Correctly Classified: {:5.1f}%".format(results_stats_dic['pct_correct_breed']))
